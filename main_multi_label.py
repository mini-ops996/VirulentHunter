...
from train_multi_label import train_protein_model
...
def main():
    ...
    parser.add_argument('--input_fasta_path', default='multi-label/train.fasta', 
                        help='the input fasta and label file path.')
    parser.add_argument('--input_label_path', default='multi-label/train_labels.pkl', 
                        help='the input fasta and label file path.')
    ...
    train_protein_model(args.esm_path, args.input_fasta_path, 
                        args.input_label_path, 
                        args.max_len)
